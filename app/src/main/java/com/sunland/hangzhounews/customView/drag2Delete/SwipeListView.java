...
package com.sunland.hangzhounews.customView.drag2Delete;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mFirstX = lastX;
                mFirstY = lastY;
                int motionPosition = pointToPosition((int) mFirstX, (int) mFirstY, ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition());

                if (motionPosition >= 0) {
                    View currentItemView = getChildAt(motionPosition - ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition());
...
//        }
    ...
    public int pointToPosition(int x, int y, int mFirstPosition) {
